export default {
  ...
  article: {
    ...
    tablet: 'Mục lục',
    types: {
      workflow: { title: 'Bộ công việc' },
      devflow: { title: 'Bộ nhà phát triển' },
      kitflow: { title: 'Bộ công cụ' },
    },
    read: 'Xem',
  },
  home: {
  ...
  work: {
    ...
    community: {
      title: 'Cộng đồng',
      content: 'Cộng đồng kết nối trên cuộc hành trình kỹ sư của tôi.',
    },
  },
  404: {
  ...
  Bio: {
    ...
    news: {
      title: 'Bản tin',
      desc: 'Đồng hành cùng với tôi, cam kết không quảng cáo. Tôi sẽ cập nhật, gửi bạn những thông tin và mẹo liên quan đến công nghệ, đời sống.',
      holder: 'Email của bạn',
      btn: 'Tham gia',
    },
  },
  Blue: {
  ...
  ErrorBanner: {},
  Floating: {},
  Footer: { title: '© 2023 Ltndat. Đã đăng ký bản quyền.' },
  LanguageButton: {},
  Navbar: {
    Home: 'Nhà',
    Work: 'Công việc',
