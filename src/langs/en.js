export default {
  ...
  article: {
    ...
    types: {
      ...
      devflow: { title: 'Devflow' },
      kitflow: { title: 'Kitflow' },
    },
    read: 'Read',
  },
  home: {
  ...
  use: {
    ...
    types: { work: 'Workflow', dev: 'Workflow', kit: 'Kitflow' },
    btn: 'Check',
    detail: 'Detail',
  },
  work: {
    ...
    community: {
      title: 'Community',
      content: 'The communitys on my developer journey.',
    },
  },
  404: {
    title: 'Not found 404 - ⚽',
  ...
  Bio: {
    ...
    social: { title: 'On the web' },
    news: {
      title: 'Newspaper',
      desc: 'Join me on my journey. No ads, I will send you something news or tips toward technology and life.',
      holder: 'Your email here',
      btn: 'Join',
    },
  },
  Blue: {
  ...
  ErrorBanner: {},
  Floating: {},
  Footer: { title: '© 2023 Ltndat. All Rights Reserved.' },
  LanguageButton: {},
  Navbar: {
    Home: 'Home',
    Work: 'Work',
